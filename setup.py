...
setup(
    ...
    description='Tool to check mendelian errors and estimate if father is father',
    ...
    url='https://github.com/moonso/variant_integrity',
    ...
    entry_points=dict(
        console_scripts=[
            'variant_integrity = variant_integrity.__main__:cli',
        ],
    ),
